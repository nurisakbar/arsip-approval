        ...
        <div class="box box-warning box-solid">
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                ...
                <table class='table table-bordered>'        
                    ...
                    <tr id="perdes">
                    <td width='200'>
                    Pilih Perdes <?php echo form_error('id_user_level') ?>
                    </td>
                    <td>
                    <?php echo cmb_dinamis('id_perdes', 'view_perdes', 'full_name', 'id_perdes', $id_perdes, 'DESC') ?>
                    </td>
                    </tr>
                    ...
                    <tr><td>Kecamatan</td><td><?php echo cmb_dinamis('id_bidang', 'tbl_bidang', 'nama_bidang', 'id', $id_bidang, 'DESC') ?></td></tr>
